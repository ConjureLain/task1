...
//				test6 funs = new test6();
//				int res = funs.calDur(cell6);
//				
//				//if less than 150min(2h30min) then return it's first name and last name
//				if(res<=150) {
...
//			}
//			//writing the file.
//			wb.write(new FileOutputStream("C:/Users/Lain/Desktop/Marlabs/additional task/AbsList.xlsx"));//将临时写的文件合并，输出整个文件
//
//		} catch (IOException e) {
//			e.printStackTrace();
//		}
